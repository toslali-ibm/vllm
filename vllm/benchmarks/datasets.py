...
unique_prompts = [
    "You are a useful AI assistant. Your goal is to explain complex subjects in a simple and clear way. Use everyday language and relatable analogies to make difficult ideas easy to understand. Avoid jargon whenever possible, or define it clearly if you must use it. Your tone should be patient and encouraging, like a good teacher who wants to help someone learn. The filament of the antique lightbulb glowed with a warmth modern LEDs could never replicate, casting long, dancing shadows across the room from the slightest vibration on the wooden floor. Somewhere in the city, a baker was pulling the first batch of sourdough from a brick oven, the crust crackling in the cool morning air. The ancient city of Petra, carved directly into the vibrant red and pink sandstone cliffs of Jordan, is an architectural marvel. The famous Treasury, or Al-Khazneh, with its ornate Hellenistic facade, was not a treasury at all but most likely a tomb for a Nabatean king. The Nabateans were master hydrologists, creating a complex system of dams, cisterns, and water conduits that allowed a bustling city to thrive in the heart of the desert. ",
    "You are a good AI assistant. Your main function is to help users brainstorm ideas for any project or situation. Provide a wide variety of creative and diverse suggestions. To better help the user, you can ask clarifying questions about their goals. Organize the final list of ideas with headings or bullet points to keep them clear. Your tone should be enthusiastic and open-minded to encourage creativity. The way a flock of starlings moves in unison, a phenomenon known as a murmuration, is a breathtaking example of emergent behavior. There is no single leader; instead, each bird follows a simple set of rules related to the position and velocity of its immediate neighbors. From these local interactions, a complex, fluid, and seemingly choreographed aerial ballet unfolds across the sky, a whole far greater and more beautiful than the sum of its individual parts. It’s a decentralized system that achieves a level of coordination that would be impossible with a top-down command structure. In the world of materials science, aerogel is a fascinating substance. Often called frozen smoke, it is a synthetic porous ultralight material derived from a gel, in which the liquid component for the gel has been replaced with a gas. The result is a solid with extremely low density and low thermal conductivity. A block of aerogel the size of a person weighs less than a pound, yet it can support thousands of times its own weight. Its most remarkable property is as a thermal insulator; it can protect a flower from the heat of a blowtorch. NASA has used aerogel to trap space dust particles from a comet's tail and to insulate the Mars rovers from the planet's frigid temperatures. ",
    "You are a friendly AI assistant. Your task is to help users break down any problem into small, manageable steps. When a user presents a challenge, your purpose is to guide them in creating a logical plan to solve it. Focus on providing a clear, step-by-step process they can follow. Your tone should be logical, calm, and supportive, helping the user feel confident they can tackle the issue. In the culinary world, the Maillard reaction is the magic that gives browned food its delicious flavor. It's a complex chemical dance between amino acids and reducing sugars that occurs at high temperatures, creating hundreds of new aroma and flavor compounds. It's why a seared steak is more flavorful than a boiled one, why toast tastes different from bread, and why roasted coffee has such a rich, aromatic profile. It's not burning; it's a controlled, delicious transformation that is fundamental to almost every cooking tradition around the globe. This process relies on the absence of water, which is why you must pat a steak dry to get a good sear. The energy from the heat would otherwise be spent boiling the water rather than browning the surface. ",
    "You are a funny AI assistant. Your primary role is to read, understand, and summarize long pieces of text. When given an article, report, or any other document, your goal is to extract the main points and present them in a concise and easy-to-read format. You can use bullet points or a short paragraph for the summary. Your tone should be neutral, efficient, and informative. This stands in stark contrast to the rigid, hierarchical construction of a beaver dam, one of the few examples of animals other than humans creating structures capable of drastically altering their environment. The sound of running water triggers a beaver's instinct to build, and they will work tirelessly, using mud, stones, and sticks to stop the flow. Their dams create wetlands that support a rich diversity of life, making them a keystone species. The engineering is innate, a genetic blueprint for manipulating hydrology that has been perfected over millions of years. The quiet patience of a chess grandmaster, contemplating a board state twenty moves deep, is another form of complex problem-solving. They don't just see the pieces on the board; they see a web of potential futures, a branching tree of possibilities where each move and counter-move opens new pathways and closes others. This ability to visualize abstract patterns and anticipate an opponent's strategy is a form of intelligence that is both deeply analytical and fiercely creative, a battle of pure intellect played out on a field of 64 squares. ",
    "You are a nice AI assistant. Your purpose is to act out different roles or simulate scenarios for the user. You should be able to adopt various personas, such as a job interviewer, a customer, or a debate partner, based on the user's request. Stay in character and respond realistically within the context of the situation. Your tone should be adaptable and convincing for whichever role you are playing. The human brain's ability to process language is another marvel. Broca's area and Wernicke's area, two specific regions in the cerebral cortex, work in concert to allow for the production and comprehension of speech. Damage to Broca's area can result in expressive aphasia, where a person knows what they want to say but struggles to form the words, while damage to Wernicke's area can cause receptive aphasia, where a person can speak fluently but their words are nonsensical and they cannot understand others. The intricate neural wiring that connects these and other regions allows for the seamless flow of thought into communication, a process we take for granted every time we speak. The brain is not just a computer; it's a dynamic, living network that rewires itself based on experience, a principle known as neuroplasticity."
]
        ...
        **kwargs,
        ...
        for idx in range(num_requests):
            ...
            if not is_valid_sequence(prompt_len=actual_prompt_len_tokens,
                ...
                print(f"Invalid seq of length {actual_prompt_len_tokens} output length {output_len}, index = {idx} target_len = {target_len} prefix_len={prefix_len}")
                continue
            samples.append(
                SampleRequest(
                    prompt=final_prompt,
